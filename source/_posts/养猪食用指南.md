...
tags:
  - Linux
categories: Linux
cover: "https://image.6669998.xyz/uOGPog.webp"
description: 养猪食用指南
abbrlink: e318ccac
top: 
...
```markdown
docker run --restart=on-failure --name soga_ss -d \
-v /etc/soga/:/etc/soga/ --network host \
-e type=v2board \
-e server_type=ss \
-e node_id=6 \
...
```
sudo find / -type d -name theme 2>/dev/null
```

- 拉取文件至:xxxxx.com//public/theme
- 并且重命名为：Bob-Theme-Argon


```shell
git clone https://github.com/BobCoderS9/Bob-Theme-Argon
```

- [主题github 地址](https://github.com/BobCoderS9/Bob-Theme-Argon)


## 启动主题及效果展示

![668a02485c92e.png](https://image.6669998.xyz/521VAx.png)

- 效果展示

![668a02308ff0a.png](https://image.6669998.xyz/F0vRDB.png)
